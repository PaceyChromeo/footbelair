const fr = {
  ...
  applyPenalty: "Pénalité",
  penaltyDialogTitle: "Appliquer une pénalité à {name} ?",
  penaltyDefaultDescription: "Survolez un type de pénalité pour voir sa description.",
  lateCancellationDescription: "Le joueur sera placé en dernière position des files d'attente pendant 2 semaines (mais pourra jouer si aucune place n'est prise).",
...
rulesSec8Title: "8. Contact",
  ...
  confirmed: "Confirmé ✓",
  confirmMatchTitle: "Confirmer ce match ?",
  confirmMatchDescription: "Un email de confirmation sera envoyé à tous les joueurs inscrits (joueurs + file d'attente) avec la liste des joueurs.",
  ...
  schedule: "Calendrier",
  blockedEmailDomain: "Tu n'es pas autorisé à utiliser ton adresse email professionnelle pour créer un compte.",
} as const;
